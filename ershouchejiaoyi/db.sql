...
*/
USE ershouchejiaoyi;
INSERT INTO cheliang (shangjia_id, cheliang_name, cheliang_photo, cheliang_types, cheliang_new_money, cheliang_clicknum, zan_number, cai_number, cheliang_content, shangxia_types, cheliang_delete, create_time) VALUES
(5, '精选高品质代步好车', 'car1.jpeg', 3, 35000.00, 15, 2, 0, '<p>车况极佳，原版原漆，按时保养，是日常代步的绝佳选择。没有泡水没有火烧，支持第三方检测！</p>', 1, 1, NOW()),
(5, '大气豪华商务座驾', 'car2.jpeg', 4, 128000.00, 42, 5, 1, '<p>这是一辆非常奢华的商务型用车，内饰几乎保持九成新，空间宽敞无比。老板一手车，手续齐全，随时准备过户。</p>', 1, 1, NOW()),
(5, '非常适合全家出游的旅行车', 'car3.jpeg', 5, 86000.00, 20, 1, 0, '<p>宽敞的大空间，舒适的座椅，极为平顺的底盘悬挂，极其适合二胎家庭周末出游，性能依然非常稳定。</p>', 1, 1, NOW()),
(5, '充满肌肉感的城市运动小钢炮', 'car4.jpeg', 3, 62000.00, 88, 12, 1, '<p>动力随叫随到，百公里加速表现亮眼，操控极其灵活！非常适合喜欢驾驶乐趣的年轻人，底盘紧致如新。</p>', 1, 1, NOW()),
(5, '超凡性价比实用优选', 'car5.jpeg', 4, 45000.00, 31, 4, 0, '<p>极度省油耐造，无论是刚拿驾照练手还是日常上下班通勤，这款车都表现得相当完美，综合性价比全场最高。</p>', 1, 1, NOW());
...
CREATE TABLE `cheliang_order` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='汽车订单';
/*Data for the table `cheliang_order` */
insert  into `cheliang_order`(`id`,`cheliang_order_uuid_number`,`cheliang_id`,`yonghu_id`,`shangjia_id`,`cheliang_order_price`,`cheliang_order_status_types`,`insert_time`,`pay_time`,`finish_time`,`cancel_reason`,`create_time`) values (1,'20220425120000001',1,1,2,'174.44',4,'2022-04-25 12:00:00','2022-04-25 12:10:00','2022-04-25 13:00:00',NULL,'2022-04-25 12:00:00');
...
/*Data for the table `cheliang_cart` */
insert  into `cheliang_cart`(`id`,`cheliang_id`,`yonghu_id`,`insert_time`,`create_time`) values (1,1,1,'2022-04-25 12:30:00','2022-04-25 12:30:00'),(2,2,1,'2022-04-25 12:35:00','2022-04-25 12:35:00');
